...
function validateUserInputEdit(row, firstName, lastName, email, phoneNumber) {
  ...
  if (hasErrors) {
    ...
    errorCell.innerHTML = `
      ${!validationResults.firstName.valid ? '<span class="fa-exclamation-triangle"></span>' + validationResults.firstName.message + '<br>' : ''}
      ${!validationResults.lastName.valid ? '<span class="fa-exclamation-triangle"></span>' + validationResults.lastName.message + '<br>' : ''}
      ${!validationResults.email.valid ? '<span class="fa-exclamation-triangle"></span>' + validationResults.email.message + '<br>' : ''}
      ${!validationResults.phoneNumber.valid ? '<span class="fa-exclamation-triangle"></span>' + validationResults.phoneNumber.message + '<br>' : ''}
    `;
